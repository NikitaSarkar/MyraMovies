package info.nikita.myramovies.omdbApiRetrofitService;
...
public class searchService {
    private static final String API_URL = "http://www.omdbapi.com?i=tt3896198&apikey=8c0e72e1";
            ...
            httpClient.addInterceptor(new Interceptor() {
                ...
                public Response intercept(Chain chain) throws IOException {
                    ...
                    HttpUrl url = originalHttpUrl.newBuilder()
                            .addQueryParameter("apikey", "8c0e72e1")
                            .build();
